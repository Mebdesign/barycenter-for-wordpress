class BarycenterCalculator {
    ...
    onMapClick(e) {
        ...
        if (e.originalEvent.isTrusted) {
            ...
            var limit = (typeof barycenterParams.limits !== 'undefined' && !isNaN(parseInt(barycenterParams.limits, 10))) ? parseInt(barycenterParams.limits, 10) : 100;

            if ((!barycenterParams.hasPurchased || !barycenterParams.hasSubscribed) && barycenterCalculator.markers.length >= limit) {
